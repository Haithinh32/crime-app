    <div class="w-[276px] h-[1080px] absolute bg-gradient-to-t from-[#f9b115] via-[#d15519] to-red-700">
      ...
      <div class="w-[251px] h-[312.64px] left-[12px] top-[63px] absolute">
        ...
        <a href = "{{route('authorize')}}" class="w-[251px] h-[50px] left-0 top-[198px] absolute bg-white rounded-[50px] border border-black  overflow-hidden">
        ...
        <div class="w-[251px] h-[50px] left-0 top-[66px] absolute bg-white rounded-[50px] border border-black  overflow-hidden">
      ...
      <a href="{{ route('profile') }}" class="w-[276px] h-16 left-0 top-[1016px] absolute  overflow-hidden">
    <div class="w-[150px] h-9 left-[64px] top-[14px] absolute">
      <div class="left-0 top-[18px] absolute justify-start items-start gap-2.5 inline-flex">
      ...
      <div class="left-0 top-0 absolute justify-start items-start gap-0.5 inline-flex">
        <div class="text-[#161616] text-[15px] font-bold font-['Inter']">anhthao</div>
      </div>
    </div>
