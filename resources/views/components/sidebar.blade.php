<div class="w-[276px] h-[1080px] relative">
  <div class="w-[276px] h-[1080px] left-0 top-0 absolute bg-gradient-to-t from-[#f9b115] via-[#d15519] to-red-700">
    <div class="left-[12px] top-[4px] absolute flex-col justify-start items-start gap-2 inline-flex">
      ...
      <div class="w-[251px] h-[50px] relative bg-white rounded-[50px] border border-black">
        ...
        <button href="{{ route('homepage') }}" class="left-[57px] top-[13px] absolute text-[#161616] text-[19px] font-bold font-['Inter']">Trang chủ</button>
      </div>
    </div>
  </div>
  <div class="w-10 h-10 left-[12px] top-[1028px] absolute"></div>
  <div class="w-[276px] h-16 left-0 top-[1016px] absolute">
  ...
  <div class="w-[205px] h-[48.64px] left-[35px] top-[516px] absolute">
    ...
    <button href="{{ route('homepage') }}" class="w-[144.19px] h-[26.93px] left-[33.01px] top-[11.29px] absolute text-center text-[#161616] text-xl font-bold font-['Inter']">Tạo bài đăng</button>
  </div>
</div>