<div class="w-[276px] h-[1080px] relative">
  <div class="w-[276px] h-[1080px] left-0 top-0 absolute bg-gradient-to-t from-[#f9b115] via-[#d15519] to-red-700">
    <div class = "w-[50px] h-[46.30px] left-[6px] top-[4px] absolute">
      <img class="w-[50px] h-[46.30px]" src="{{asset('image\SystemImg\Logo.png')}}" />
    </div>
    <div class="left-[12px] top-[4px] absolute flex-col justify-start items-start gap-2 inline-flex">
      ...
      <a href="{{ route('homepage') }}" class="w-[251px] h-[50px] relative bg-white rounded-[50px] border border-black">
  ...
  <img class="w-[50px] h-[46.30px] left-[6px] top-[4px] absolute" src="{{asset('image\SystemImg\User Circle Single.png')}}" />
</a>
