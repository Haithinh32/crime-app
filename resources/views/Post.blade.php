    ...
    <form action="{{ route('create_post') }}" method="POST" enctype="multipart/form-data">
        <div class="w-[475px] h-[717px] relative">
            ...
            <div class="w-[381.99px] h-[65.78px] left-[37.01px] top-[119.72px] absolute">
                ...
                <input type="text" name="title" placeholder="Nhập vào đây" class="w-[381.99px] h-[31.83px] left-0 top-[33.95px] absolute bg-white rounded-[10px] border border-black"></input>
            </div>
            ...
            <div class="w-[381.99px] h-[62.65px] left-[37px] top-[197.18px] absolute">
                ...
                <input type="text" name="" placeholder="Nhập vào đây" class="w-[381.99px] h-[31.83px] left-0 top-[30.82px] absolute bg-white rounded-[10px] border border-black"></input>
            </div>
            ...
            <div class="w-[382px] h-[200px] left-[36.70px] top-[275px] absolute">
                ...
                <input type="textfield" name="content" placeholder="Nhập vào đây" class="w-[382px] h-[166px] left-0 top-[34px] absolute bg-white rounded-[10px] border border-black"></input>
            </div>
            ...
            <div class="w-[381.99px] h-[31.83px] left-[37px] top-[487px] absolute">
                ...
                <div class="relative">
                    <input type="file" name="img" class="w-5 h-5 left-[9px] top-[6px] absolute opacity-0 cursor-pointer z-10">
                    <img src="{{ asset('image\SystemImg\Gallery.jpg') }}" class="w-5 h-5 absolute left-[9px] top-[6px]" alt="Gallery Icon">
                </div>
                <div class="relative">
                    <input type="file" name="vid" class="w-5 h-5 left-[43px] top-[6px] absolute opacity-0 cursor-pointer z-10">
